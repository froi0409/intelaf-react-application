...
interface HeadCell {
    ...
    id: keyof InTimePendingVerifyStructure;
    label: string;
    numeric: boolean;
}
...
const headCells: readonly HeadCell[] = [
    ...
    {
        id: 'nameStoreShipping',
        numeric: false,
        disablePadding: false,
        label: 'codigo de la tienda de envio',
    },
    {
        id: 'nameStoreReceive',
        numeric: false,
...
interface EnhancedTableProps {
    numSelected: number;
    onRequestSort: (event: React.MouseEvent<unknown>, property: keyof InTimePendingVerifyStructure) => void;
    order: Order;
    orderBy: string;
    rowCount: number;
}
...
function EnhancedTableHead(props: EnhancedTableProps) {
    ...
    const createSortHandler =
        (property: keyof InTimePendingVerifyStructure) => (event: React.MouseEvent<unknown>) => {
...
export const TableReportInTime = ({dataServer}: any) => {
    const rows = dataServer;
    const [order, setOrder] = React.useState<Order>('asc');
    const [orderBy, setOrderBy] = React.useState<keyof InTimePendingVerifyStructure>('idOrder');
    ...
    const handleRequestSort = (
        ...
        property: keyof InTimePendingVerifyStructure,
      ) => {
                ...
                {visibleRows.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.nameStoreShipping}</TableCell>
                      <TableCell align="right">{row.nameStoreReceive}</TableCell>
